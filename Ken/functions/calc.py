...
def calculate(op):
    ...
    if op == "add" or op == 'subtract' or op == 'multiply' or op == 'divide' or op == "modulus" or op == "floor_divide":
        ...
        try:    
            ...
            print("Please enter a valid integer.")
            exit()
    elif op == "factorial" or op == "sine" or op == "cosine" or op == "tangent":
        input_1 = input("Enter a number: ")
        try:    
            num = float(input_1)
        except:
    ...
    if op == "add":
        ...
        sin_num = sine(num)
        print(f"The result of sine of {num} is {sin_num}")
    elif op == "cosine":
        cos_num = cosine(num)
        print(f"The result of cosine of {num} is {cos_num}")
    elif op == "tangent":
        tan_num = tangent(num)
        print(f"The result of tangent of {num} is {tan_num}")
    else:
